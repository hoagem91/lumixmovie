...
public class CommentReactionService {
    ...
    public String getUserReaction(String commentId){
        try{
            String username = SecurityContextHolder.getContext().getAuthentication().getName();
            ...
            Optional<CommentReaction> reactionOpt = commentReactionRepository.findByComment_IdAndUser_UserId(commentId,user.getUserId());
            ...
            log.error("💥 Error getting user reaction for comment [{}]: {}", commentId, ex.getMessage(), ex);
            return "NONE";
        }
    }
}
